...
# -	'ordenado', el valor es una tupla de tuplas, donde cada tupla (nombre, promedio) está ordenado de forma descendente por promedio (mayor a menor)
...
def mejores_estudiantes(estudiantes: pd.DataFrame)-> dict:
    ...
    # print (estudiantes)
    # Procedemos ahora con el ordenamiento de forma descendente
    salida1 = estudiantes.sort_values ( by = ['promedio'], ascending =  False, ignore_index = True  )
    # print (salida1['nombre'], salida1['promedio'])
    
    
    # Segundo Punto, mejor promedio
    mayorPromedio = max (salida1['promedio'])
    # print ('el mayor promedio fue ', mayorPromedio)
    salida2 = salida1.loc [  salida1['promedio'] == mayorPromedio   ]
    # print (salida2)
    
    
    # Tercer Punto, promedio susperiores a 4.0
