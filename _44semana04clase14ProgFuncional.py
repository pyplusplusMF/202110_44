...
# 1. Las funciones pueden ser asignadas a variables.

# 2. Las funciones pueden ser utilizadas como argumento de otras funciones

# 3. Las funciones pueden retornar otras funciones
